...
process.source = cms.Source("PoolSource",
        fileNames = cms.untracked.vstring('file:/eos/user/y/ykao/www/HGCAL_Geant4_project/testbeam_positron_D86_R80To130_E100/step2.root')
        )

process.maxEvents = cms.untracked.PSet( input = cms.untracked.int32(1))

from DQMServices.Core.DQMEDAnalyzer import DQMEDAnalyzer
process.DummyRecHitDQMEDAnalyzer = DQMEDAnalyzer('DummyRecHitDQMEDAnalyzer')
...
process.p = cms.Path(process.DummyRecHitDQMEDAnalyzer)
